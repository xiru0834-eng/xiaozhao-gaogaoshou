...
The coach navigation opens six separate pages: **题库练习**, **模拟面试**, **岗位专项**, **复习计划**, **练习记录**, and **已斩题**. The bank supports keyword search and topic filters; **练习记录** opens an ongoing practice or a completed report. Internal page switches retain the current answer draft.
