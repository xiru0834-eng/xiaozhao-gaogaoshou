...
状态：阶段 1 数据基础 T01–T05 已实现并验收；T06 原生助手和后续 AI 更新仍待实现。前置 TS 迁移详见 [迁移记录](../docs/TypeScript迁移.md)。后续先审阅 [计划](plan.md) 和 [规格](../docs/本地AI更新功能规格.md)。每个任务先补失败测试/固定输入，再实现；任务结束记录实际证据，不凭描述勾选。
